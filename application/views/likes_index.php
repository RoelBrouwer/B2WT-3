   	<div class="wrapper">
	   	<div class="container">
			--Tekst over overzichten algemeen-- <br />
			<h3><a href="<?php echo base_url(); ?>likes/my_likes">Mijn likes</a></h3>
			--Tekst over mijn likes-- <a href="<?php echo base_url(); ?>likes/my_likes">Ga naar mijn likes</a>
