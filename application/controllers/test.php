...
class Test extends CI_Controller {
	...
	public function index()
	{
		...
		$data['questions'] = array('q1' => array('question' => "Tekst voor vraag 1", 'tag' => "q1", 'answers' => array('a' => array('value' => "tag1", 'text' => "Tekst1"), 'b' => array('value' => "tag2", 'text' => "Tekst2"), 'c' => array('value' => "tag3", 'text' => "Tekst3"))));
